					...
					<div class="col-md-6">
						<div class="form-box">
							...
							<div class="form-bottom" id="form-bottom">
								<form action="/Egov-proj/assets/php/validation.php" class="login-form" method="post">
									...
									<button class="btn" id="loginBtn" name="loginBtn" style=" text-align:center;" type="submit">Log in</button>
