					...
					<div class="card">
						<div class="header">
							...
							<form method="post" id="message-form" class="message-form" name="message-form">
									...
									<div class="row">
									<div class="col-md-6">
										<label for="recipients">To:</label><br>
										<input class="form-control" type="text" class="recipients" id="recipients" name="recipients" placeholder="Recipients" required>
									</div>
									</div>
									<div class="row">
									<div class="col-md-6">
										<label for="subject">Subject:</label><br>
										<input class="form-control" type="text" class="subject" id="subject" name="subject" placeholder="Subject">
									</div>
									</div>
									<div class="row">
									<div class="col-md-8">
										<label for="message">Message:</label><br>
										<textarea  class="message form-control" id="message" name="message"></textarea>
									</div>
									</div>
									<div class="row">
									<div class="col-md-2">
									<button type="submit" id="subm" name="subm" class="btn btn-info btn-md">Send Message</button>
									</div>
									</div>
								</form>
						</div>
